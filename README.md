...
| infinite                  | Boolean | false   | Flag to make the carousel continue when reaching the end. Locks: paginationEnabled: false, scrollPerPage: false, navigationEnabled: true for now.                                                                                                                                       |
