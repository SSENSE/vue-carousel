...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Slide = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/johanntroendle/SSENSE/vue-carousel/src/Carousel.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-a5cbe476", Component.options)
	  } else {
	    hotAPI.reload("data-v-a5cbe476", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(5)("17bb88aa", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-a5cbe476&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Carousel.vue", function() {
	     var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-a5cbe476&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Carousel.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.carousel[data-v-a5cbe476] {\n  width: 100%;\n  position: relative;\n  overflow: hidden;\n}\n.carousel-inner[data-v-a5cbe476] {\n  display: flex;\n  flex-direction: row;\n  backface-visibility: hidden;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoplay = __webpack_require__(77);
	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      ...
	      slideWidth: null,
	      dragging: false,
	      isTouch: (typeof window === "undefined" ? "undefined" : (0, _typeof3.default)(window)) !== undefined && "ontouchstart" in window
	    };
	  },
	  ...
	  computed: {
	    ...
	    currentPerPage: function currentPerPage() {
	      return !this.perPageCustom || this.$isServer ? this.perPage : this.getBreakpointSlidesPerPage(this.perPageCustom, this.browserWidth);
	    },
	    ...
	    maxOffset: function maxOffset() {
	      return this.slideWidth * (this.slideCount - this.currentPerPage);
	    }
	  },
	  methods: {
	    ...
	    calculateSlideWidth: function calculateSlideWidth() {
	    ...
	    getBreakpointSlidesPerPage: function getBreakpointSlidesPerPage(breakpointArray, width) {
	    ...
	    onDown: function onDown(e) {
	      document.addEventListener(this.isTouch ? "touchend" : "mouseup", this.onUp);

	      document.addEventListener(this.isTouch ? "touchmove" : "mousemove", this.onMove);
	    ...
	    onUp: function onUp() {
	      ...
	      document.removeEventListener(this.isTouch ? "touchend" : "mouseup", this.onUp);
	      document.removeEventListener(this.isTouch ? "touchmove" : "mousemove", this.onMove);
	    },
	    onMove: function onMove(e) {
	      var eventPosX = this.isTouch ? e.touches[0].clientX : e.clientX;
	      this.dragOffset = this.dragStartX - eventPosX;

	      if (this.isTouch && this.dragOffset < this.minSwipeDistance) {
	        return;
	      }
	      ...
	      if (nextOffset < 0) {
	        this.dragOffset = -Math.sqrt(-this.bouncingCoef * this.dragOffset);
	      } else if (nextOffset > this.slideWidth * this.slideCount) {
	        this.dragOffset = Math.sqrt(this.bouncingCoef * this.dragOffset);
	      }
	    },
	    ...
	    setChildSlideWidth: function setChildSlideWidth(width) {
	      if (this.$slots.default) {
	        this.$slots.default.map(function (child) {
	          var slotChild = child;
	  ...
	  mounted: function mounted() {
	    if (!this.$isServer) {
	      ...
	      this.$refs['carousel-inner'].addEventListener(this.isTouch ? "touchstart" : "mousedown", this.onDown);
	    }
	  ...
	  destroyed: function destroyed() {
	    if (!this.$isServer) {
	      ...
	      this.$refs['carousel-inner'].removeEventListener(this.isTouch ? "touchstart" : "mousedown", this.onDown);
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/johanntroendle/SSENSE/vue-carousel/src/Navigation.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-41c4fd39", Component.options)
	  } else {
	    hotAPI.reload("data-v-41c4fd39", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(5)("d21fcb34", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-41c4fd39&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Navigation.vue", function() {
	     var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-41c4fd39&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Navigation.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-41c4fd39", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/johanntroendle/SSENSE/vue-carousel/src/Pagination.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-4019f7bf", Component.options)
	  } else {
	    hotAPI.reload("data-v-4019f7bf", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(5)("07899b99", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4019f7bf&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Pagination.vue", function() {
	     var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4019f7bf&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Pagination.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.pagination[data-v-4019f7bf] {\n  width: 100%;\n  float: left;\n  text-align: center;\n}\n.dot-container[data-v-4019f7bf] {\n  display: inline-block;\n  margin: 0 auto;\n}\n.dot[data-v-4019f7bf] {\n  float: left;\n  cursor: pointer;\n}\n.dot-inner[data-v-4019f7bf] {\n  border-radius: 100%;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-4019f7bf", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    style: (("\n      transform: translateX(" + _vm.currentOffset + "px);\n      transition: " + (!_vm.dragging ? _vm.transitionStyle : 'none') + ";\n    "))
	  }, [_vm._t("default")], 2), _vm._v(" "), (_vm.navigationEnabled) ? _c('navigation') : _vm._e(), _vm._v(" "), (_vm.paginationEnabled && _vm.pageCount > 0) ? _c('pagination') : _vm._e()], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-a5cbe476", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/johanntroendle/SSENSE/vue-carousel/src/Slide.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-4833211c", Component.options)
	  } else {
	    hotAPI.reload("data-v-4833211c", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(5)("51ebb628", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4833211c&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Slide.vue", function() {
	     var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4833211c&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Slide.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: "slide",
	    style: (("\n    flex-basis: " + _vm.width + "px;\n    visibility: " + (_vm.width ? 'visible' : 'hidden') + "\n  "))
	  }, [_vm._t("default")], 2)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-4833211c", module.exports)
	  }
	}
