			...
			e.default = {
				...
				methods: {
					...
					getCarouselWidth: function() {
						...
						return (
							(this.carouselWidth = (t && t.clientWidth) || 0), this.carouselWidth
						);
					},
					...
					goToPage: function(t) {
						t >= 0 &&
							...
							((this.offset = this.scrollPerPage
								? Math.min(this.slideWidth * this.currentPerPage * t, this.maxOffset)
				...
				mounted: function() {
					window.addEventListener(
						'resize',
						(0, c.default)(this.onResize, this.refreshRate)
					),
						(this.isTouch || this.mouseDrag) &&
								...
								t._l(t.carousel.pageCount, function(e, i) {
									return n(
										'li',
										{
											...
											class: { 'VueCarousel-dot--active': t.isCurrentDot(i) },
											style:
												'\n        margin-top: ' +
										...
										[
											n('button', {
												...
												style:
													...
													';\n        ',
												attrs: { type: 'button', role: 'button', tabindex: i }
											})
										]
									);
								})
			...
			e.default = {
				...
				methods: {
					onTouchEnd: function(t) {
						var e =
								this.carousel.isTouch && t.changedTouches && t.changedTouches.length > 0
						...
						(0 === this.carousel.minSwipeDistance ||
							...
							this.$emit('slideClick', (0, a.default)({}, t.currentTarget.dataset));
					}
				}
			};
		},
		...
		function(t, e, n) {
			...
			t.exports =
				...
				n(23)(function() {
					...
					? function(t, e) {
							for (
								var n = o(t), u = arguments.length, c = 1, l = r.f, d = a.f;
								u > c;
			...
			t.exports = function(t) {
				return function(e, n, o) {
					...
					if (t && n != n) {
						...
						for (; c > l; l++) if ((t || l in u) && u[l] === n) return t || l || 0;
					return !t && -1;
				};
			};
		},
				...
				render: function() {
					...
					return n(
						...
						[
							...
							t._v(' '),
							t.paginationEnabled && t.pageCount > 0
								? n('pagination', {
										on: {
